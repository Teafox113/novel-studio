  ...
  return <div className="version-info" ref={root}>
    ...
    {open && <section id="version-panel" className="version-panel" aria-label="版本資訊">
      ...
      <h3>v{version} 更新內容</h3><ul>
        ...
        <li>我的小說專案：新建、開啟、另存獨立副本，切換前建立安全快照。</li><li>新增 Windows 免安裝 ZIP 與完整使用指南。</li>
      </ul>
      <h3>近期版本</h3><p>0.10.0 · 打字機模式、版本比較與版本資訊<br />0.9.0 · 研究浮窗、快速收集與可讀性設定<br />0.8.0 · 全專案搜尋與快速導覽<br />0.7.0 · 本機 AI 審核中心</p>
