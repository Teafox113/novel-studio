  ...
  return <div className="version-info" ref={root}>
    ...
    {open && <section id="version-panel" className="version-panel" aria-label="版本資訊">
      ...
      <h3>v{version} 更新內容</h3><ul>
        ...
        <li>架空歷史一覽：自訂曆法、紀元、月份天數與週日名稱。</li><li>虛構日期排序、紀元前年代、事件與場景／世界觀連結。</li><li>schema v7 保留曆法與編年，匯出檔記錄正確程式版本。</li>
      </ul>
      <h3>近期版本</h3><p>0.11.0 · 多小說專案管理與免安裝版<br />0.10.0 · 打字機模式、版本比較與版本資訊<br />0.9.0 · 研究浮窗、快速收集與可讀性設定<br />0.8.0 · 全專案搜尋與快速導覽<br />0.7.0 · 本機 AI 審核中心</p>
