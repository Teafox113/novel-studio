...
- **版本資訊更完整**：加入創作者頭像、GitHub 連結、資料處理與已知限制。
- **下載與升級更清楚**：更新安裝版、免安裝版及操作說明。
- **補齊授權文件**：提供第三方函式庫資訊與授權文字。

[查看完整更新紀錄](CHANGELOG.md) · [前往本版下載](https://github.com/Teafox113/novel-studio/releases/tag/v0.16.1)
...
開啟 **世界觀 → 選擇人物**，在「人物狀態卡」按分類旁的＋新增關鍵字。可設定物品數量、數值上限，或連結世界觀資料與來源場景；點卡片即可修改，完成後按「儲存關鍵字」。目前是作者手動設定，尚未依分支自動運算。[人物卡使用說明](docs/CHARACTER_PROFILE.md)
